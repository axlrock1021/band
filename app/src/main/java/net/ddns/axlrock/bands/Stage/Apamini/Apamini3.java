...
public class Apamini3 extends AppCompatActivity implements OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apamini3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.layout.apamini3, menu);
        return true;
    }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        if (e1.getX() - e2.getX() > 50) {
            Intent intent = new Intent(this, Apamini1.class);
            ...
            Intent intent2 = new Intent(this, Apamini2.class);

...
import net.ddns.axlrock.bands.Stage.Coming_Soon.Coming_Soon1;
...
public class stage extends AppCompatActivity {
    ...
    protected void itemListMethod() {
        ...
        itemList.add(new Home_Item(4, R.drawable.revolver1, "Revolver"));
        itemList.add(new Home_Item(5, R.drawable.legacy_taipei1, "Legacy Taipei"));
        itemList.add(new Home_Item(6, R.drawable.legacy_taichung1, "Legacy Taichung"));
        itemList.add(new Home_Item(7, R.drawable.apamini1, "小地方展演空間"));
        itemList.add(new Home_Item(8, R.drawable.the_wall_live_house1, "The Wall Live House"));
        ...
        itemList.add(new Home_Item(14, R.drawable.ez5_live_house1, "EZ5 Live House"));
        itemList.add(new Home_Item(15, R.drawable.the_witch_house1, "女巫店"));
        itemList.add(new Home_Item(15, R.drawable.coming_soon1, "Coming Soon"));
                ...
                public void onClick(View v) {
                    switch (position){
                        ...
                        case 14:
                            ...
                            break;
                        case 15:
                            startActivity(new Intent().setClass(stage.this, Coming_Soon1.class));
                            break;
                    }
                }
            });

...
public class Wonfu2 extends AppCompatActivity implements OnGestureListener {
    ...
    Button streetvoice;
    //初始化網址
    String youtubeURL1 = "https://www.facebook.com/wonfu"; //fb
    String youtubeURL2 = "https://www.instagram.com/wonfulovesyou/?hl=zh-tw"; //ig
    String youtubeURL3 = "https://streetvoice.com/Wonfu/"; //streetvoice

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wonfu2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.layout.wonfu2, menu);
        return true;
    }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,float velocityY) {
        ...
        if (e1.getX() - e2.getX() > 50) {
            Intent intent = new Intent(this, Wonfu3.class);
            ...
            overridePendingTransition(R.anim.right_in, R.anim.left_out);
                ...
                Intent intent2=new Intent(this, Wonfu1.class);

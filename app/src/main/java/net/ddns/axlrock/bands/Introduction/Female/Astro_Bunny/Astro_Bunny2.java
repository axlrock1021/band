...
public class Astro_Bunny2 extends AppCompatActivity implements OnGestureListener {
    ...
    Button streetvoice;
    //初始化網址
    String youtubeURL1 = "https://www.facebook.com/astrobunnyband"; //fb
    String youtubeURL2 = "https://www.instagram.com/astrobunny_/?hl=zh-tw"; //ig
    String youtubeURL3 = "https://streetvoice.com/zhcband/"; //streetvoice

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.astro_bunny2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.layout.astro_bunny2, menu);
        return true;
    }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,float velocityY) {
        ...
        if (e1.getX() - e2.getX() > 50) {
            Intent intent = new Intent(this, Astro_Bunny3.class);
            ...
            overridePendingTransition(R.anim.right_in, R.anim.left_out);
                ...
                Intent intent2=new Intent(this,Astro_Bunny1.class);
